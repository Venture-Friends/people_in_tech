...
export function VerifyClaimStatus() {
    ...
    return (
      <div className="text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button
            nativeButton={false} render={<Link href="/discover" />}
            variant="outline"
  ...
  return (
    <div className="text-center">
      ...
      <Button nativeButton={false} render={<Link href="/discover" />} variant="outline" className="border-white/[0.08] text-white/60">
        Back to Discover
      </Button>
    </div>
  );
